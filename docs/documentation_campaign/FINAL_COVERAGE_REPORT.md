...
| HTTP API and ESP integration | Glennergy `Docs/http-api.md`, [ESP interface contract](../interface-contract.md), [connectivity](../connectivity.md) | Complete server reference and firmware-relevant consumer contract cover ID-zero, schemas, errors, cadence, cache and incompatibilities | Runtime/schema fixtures and stable end-to-end compatibility remain unverified |
