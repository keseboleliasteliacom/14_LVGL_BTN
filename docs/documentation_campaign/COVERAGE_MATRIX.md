...
| --- | --- | --- | --- | --- | --- |
| Shared system context | All | Existing READMEs/plans and code | Canonical overview | Discovery complete | Design pending |
| Cross-project interface | General and technical developers | Both HTTP implementations and old API docs | Overview plus exact current/planned contract | Discovery complete; semantic decisions pending | Design pending |
...
| Limitations/planned work | All | Owner notes, code and TODOs | Clearly separated from current behavior | Discovery complete | Continuous validation |
